 ...
 */
//WRITE YOUR CODE BELOW
const newBuiltListings = listings.filter((listing) => listing.propertySummary.builtIn.includes("1990"));
console.log(newBuiltListings)
//sorry i don't know how to do this because there's also string dates,
//i don't know how to do it as of now, but i will do my research when i have more time.
//i did it the same way as the lecture